"""
Django settings for talkthen project.
...
SECRET_KEY = 'dc5d%ndf@s@ndc+ap=#=cm-f_^%45v_icbp$1+(ys!5zz)w)%5'
...
ROOT_URLCONF = 'talkthen.urls'

WSGI_APPLICATION = 'talkthen.wsgi.application'
